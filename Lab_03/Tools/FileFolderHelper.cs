...
namespace KMA.CSharp2020.Lab03.Tools
{
    internal static class FileFolderHelper
    {
        ...
        internal static readonly string AppFolderPath = Path.Combine(AppDataPath, "CSharpKMALab4");
        internal static readonly string StorageFilePath = Path.Combine(AppFolderPath, "users");
